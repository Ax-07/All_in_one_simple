  ...
  return (
    <div className="policy-group">
      ...
      <p className="section-desc">
        Choisissez si le client doit verser un acompte lors de la réservation.
      </p>
      <Checkbox name="deposit-required"
        checked={advancedSettings.depositRequired}
        onChange={(e) =>
          handleAdvancedSettingsChange("depositRequired", e.target.checked)
        }
      >
      ...
      <input
        ...
        onChange={(e) =>
          handleAdvancedSettingsChange("depositAmount", Number(e.target.value))
        }
